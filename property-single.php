...
<body>
  ...
  <?php 
    if(isset($_GET['property-id'])){
      $property = getPropertyById($_GET['property-id']);
    } else {
      $property = 1;
    }
  ?>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single"><?php echo $property['city']; ?></h1>
              <span class="color-text-a"><?php echo $property['state']; ?></span>
            </div>
          </div>
            ...
            <div id="property-single-carousel" class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="carousel-item-b swiper-slide">
                  <img src="assets/img/property-<?php echo $iterator ?>.jpg" alt="">
                </div>
                <?php endwhile; ?>
              </div>
            </div>
                ...
                <div class="property-price d-flex justify-content-center foo">
                  <div class="card-header-c d-flex">
                    ...
                    <div class="card-title-c align-self-center">
                      <h5 class="title-c"><?php echo $property['price']; ?></h5>
                    </div>
                  </div>
                </div>
                <div class="property-summary">
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      ...
                      <li class="d-flex justify-content-between">
                        <strong>Area:</strong>
                        <span><?php echo $property['square_footage']; ?> m<sup>2</sup></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Beds:</strong>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="property-agent">
                  <h4 class="title-agent"><?php echo $property['first_name']; ?></h4>
                  <p class="color-text-a">
                    <?php echo $property['last_name']; ?>
                  </p>
                  <ul class="list-unstyled">
                    <li class="d-flex justify-content-between">
                      <strong>Phone:</strong>
                      <span class="color-text-a"><?php echo $property['phone_number']; ?></span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>License number:</strong>
                      <span class="color-text-a"><?php echo $property['license_number']; ?></span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Email:</strong>
                      <span class="color-text-a"><?php echo $property['email']; ?></span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Skype:</strong>
                      <span class="color-text-a"><?php echo $property['email']; ?></span>
